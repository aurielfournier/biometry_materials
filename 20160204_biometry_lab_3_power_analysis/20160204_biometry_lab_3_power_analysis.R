...
# That is, you should conduct a small scale study based on the actual study you would
# like to do.  
# I have done this for you and provided the data. 
# Next, you take the data and determine sample size for a given power
# or power for a given (or range of) sample size.  
# Determining power for simple tests such as basic correlations, proportion differences, and group mean differences are easy and
# straightforward.  These are the tests we will focus on today.  
# For more complex designs the power analyses become more difficult, but the principles
# are the same.

# 
# load the trout dataset 
# For your project, you need to evaluate the effects of radio transmitters
# surgically implanted in trout on their growth.  
...
# This is part of a data set from a study that some collaborators,
# students and I collected as part of a study to determine effects 
# of stream drying on crayfish habitat and refuge use. 
# I would like you to use this data to determine appropriate
# sample sizes to determine differences in adult Orconectes meeki 
# density among years.  Since we have not done it yet in class 
# I will tell you that this is a one-way ANOVA with years as 
# the grouping factor and adult O. meeki density as the 
# response variable.  Therefore, you need to determine 
# group means and standard deviations and then plug it 
# into the "One-way ANOVA" power analysis.  
